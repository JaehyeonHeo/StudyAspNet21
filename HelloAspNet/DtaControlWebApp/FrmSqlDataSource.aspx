<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmSqlDataSource.aspx.cs" Inherits="DtaControlWebApp.FrmSqlDataSource" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SdsMemoName" runat="server"
                ...
                SelectCommand="SELECT [Num], [Name] FROM [Memos] ORDER BY [Name] DESC"></asp:SqlDataSource>
