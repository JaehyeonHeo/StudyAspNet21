...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="BtnUpoad" Text="업로드" runat="server" OnClick="BtnUpoad_Click" /><br />
            ...
            <div>
                ...
                <br />
                <asp:Localize ID="LblLocal2" runat="server" Text="<hr /><b>안녕하세요</b>"
                    mode="Transform"></asp:Localize>
            </div>
        </div>
    </form>
</body>
